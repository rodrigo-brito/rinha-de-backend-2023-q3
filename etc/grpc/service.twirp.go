...
// NewStorageProtobufClient creates a Protobuf client that implements the Storage interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewStorageProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Storage {
...
// NewStorageJSONClient creates a JSON client that implements the Storage interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewStorageJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Storage {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
// NewStorageServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewStorageServer(svc Storage, opts ...interface{}) TwirpServer {
...
func (s *storageServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
...
// StoragePathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const StoragePathPrefix = "/twirp/Storage/"

func (s *storageServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Storage")
...
func (s *storageServer) serveSearch(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *storageServer) serveSearchJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Search")
		...
		handler = func(ctx context.Context, req *SearchRequest) (*SearchResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Storage.Search(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*SearchResponse)
...
func (s *storageServer) serveSearchProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Search")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *storageServer) serveGet(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *storageServer) serveGetJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Get")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
		...
		handler = func(ctx context.Context, req *GetRequest) (*User, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Storage.Get(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*User)
...
func (s *storageServer) serveGetProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Get")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *storageServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *storageServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *storageServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "", "Storage")
}
